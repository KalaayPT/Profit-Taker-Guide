---
title: Bugs
description: Major bugs that can negatively affect a speedrun
---
...
![animationbug](https://profit-taker.com/u/animationbug.jpg){style="width: 100%; height: auto;"}
::
...
::div{style="width: 100%; text-align: left;"}
![blockedleg](https://profit-taker.com/u/blockedleg.png){style="width: 100%; height: auto;"}
::
...
One way to work around this issue is [**Late Start Strat**](/guide/speedrun-strats.html#late-start-strat).
...
::div{style="width: 100%; text-align: left;"}
![assmeta](https://profit-taker.com/u/assmeta.png){style="width: 100%; height: auto;"}
::
...
[**I spent $50 on the Prime Access**](https://www.youtube.com/watch?v=VvGG9xdmAwE) (rip Okayeg’s wallet)
...
The base damage applies the formula: 40 x (1+Progenitor bonus) so you still get the Progenitor element. :br
