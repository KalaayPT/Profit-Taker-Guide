...
![Inelevator](https://profit-taker.com/u/inelevator.png){style="width: 100%; height: auto;"}
::

Out of elevator:

::div{style="width: 60%; text-align: left;"}
![outofelevator](https://profit-taker.com/u/outofelevator.png){style="width: 100%; height: auto;"}
::

And the timer ends when Profit-Taker flashes blue upon death as seen in the image:

::div{style="width: 60%; text-align: left;"}
![timerends](https://profit-taker.com/u/timerends.png){style="width: 100%; height: auto;"}
::
