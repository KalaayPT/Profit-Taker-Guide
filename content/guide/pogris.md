---
title: Pogris
description: Pogris is the name Speedrunners have given to using a Kuva Ogris with Nightwatch Napalm to take care of pylons. This can destroy pylons as they land, and damage pylons that have already landed, making this overall the fastest and most forgiving method of clearing pylons.
---
...
However, there is another major drawback to Pogris: there is very little build variety for Kuva Ogris and Frame at the high end. This is elaborated upon more in Builds (see below), but TL;DR: Volt needs a very specific riven, multiple red archon shards, no QoL mods and there is only one viable ogris build that can one-tick the pylons. Chroma doesn't suffer frorm these disadantages as much as he can reach the breakpoint to one-tick the pylons much more easily while running QoL mods and having very low stat requirements riven wise.
::
...
- Primary Overcharge gives 189% multishot when paired with Itzal built for energy max and with Preparation/Yellow Archon Shards for energy on spawn in order to reach the energy threshold to activate the arcane.
...
[Pylon Locations (Imgur)](https://imgur.com/a/profit-taker-pylons-landing-spots-Eaffg0r)
