...
export declare type CompressionType = BrotliCompression | DeflateCompression | GzipCompression | ZopfliCompression | ZstdCompression;
export declare type BrotliOptions = {
    [key: number]: number;
};
export declare type ZstdOptions = {
    level?: number;
};
export declare type ZopfliOptions = {
