...
export default defineConfig({
  ...
  head: [
    [
      "link",
      { rel: "icon", href: "https://cdn.profit-taker.com/u/favicon.ico" },
    ],
  ],
  cleanUrls: true,
  sitemap: {
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: "Codex", link: "/codex/" },
      {
        ...
        items: [
          ...
          {
            text: "Resources used",
            link: "/miscellaneous/resources-used-honorable-mentions.md",
          },
      ...
      "/guide/": [
        {
          ...
          items: [
            ...
            { text: "Basic Principles", link: "/guide/basic-principles" },
            {
              text: "Builds",
              collapsed: false,
              items: [
                { text: "Chroma Builds", link: "/guide/chroma-builds" },
                { text: "Eclipse Builds", link: "/guide/eclipse-builds" },
                { text: "Other Builds", link: "/guide/other-builds" },
                { text: "Squad Builds", link: "/guide/squad-builds" },
              ],
            },
            { text: "Riven Guide", link: "/guide/riven-guide" },
            {
              text: "Advanced Topics",
              collapsed: true,
              items: [
                { text: "Timing the Fight", link: "/guide/timing-the-fight" },
          ...
          items: [
            { text: "Codex", link: "/codex/" },
            {
              ...
              items: [
                ...
                {
                  text: "Privacy Policy",
                  link: "/miscellaneous/privacy-policy.md",
                },
                { text: "Calculator", link: "https://calc.profit-taker.com" },
                { text: "Analyzer", link: "https://basi.is-a.dev/pta/" },
              ],
      ...
      "/codex/": [
        {
          text: "Codex",
          items: [
            { text: "Overview", link: "/codex/" },
            { text: "Creating Builds", link: "/codex/creating-builds" },
            { text: "Contagion Zaws", link: "/codex/contagion-zaws" },
            { text: "Misc Trivia", link: "/codex/misc-trivia" },
            { text: "Untapped Potential", link: "/codex/untapped-potential" },
          ],
        },
        {
          text: "See also",
    ...
    socialLinks: [
      ...
      {
        icon: "github",
        link: "https://github.com/KalaayPT/Profit-Taker-Guide",
      },
      {
        icon: {
    ...
    editLink: {
      pattern:
        "https://github.com/KalaayPT/Profit-Taker-Guide/edit/master/:path",
