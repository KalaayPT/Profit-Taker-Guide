...
In terms of overall element setups, supports should aim to run elements that are typically either not covered (toxin) or relegated to Contagion: Blast, Corrosive (see [Synapse](https://overframe.gg/build/396871/)/[Catabolyst](https://overframe.gg/build/518597/), previously used on Crewmates), Gas, Cold. This is mainly because with lower FPS in squads, contagion throws get slower too.
